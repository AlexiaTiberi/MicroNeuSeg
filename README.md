...
**My personal suggestions is to first install stardist using their installation guidelines ([installation guide](https://github.com/stardist/stardist)), which requires a working tensorflow environment**
